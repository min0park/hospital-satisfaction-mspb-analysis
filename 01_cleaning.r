...
data_dir <- "/Users/amypark/Desktop/Toronto Metropolitan University (The Chang School of Continuing Education)/Data Analytics, Big Data, and Predictive Analytics Certificate/Winter 2025/CIND820 - Big Data Analytics Project/Datasets"

survey   <- read.csv(file.path(data_dir, "HCAHPS_Hospital.csv"))
spending <- read.csv(file.path(data_dir, "MSPB_Hospital.csv"))
